...
------------------------------------------------------------
	server_args = -s /home/p2119/jarsulk-pco/projects/SOD-5/Programs/m7/imx8mp_m7_i2c_bpm_bq40z50/armgcc/debug/
------------------------------------------------------------
...
sudo apt install autokey-gtk
	Configure shortcut Ctrl+Alt+Q
		Add new: TFTP in Terminal
			Command: tftp 0x48000000 imx8mp_m7_i2c_bpm_bq40z50.bin; cp.b 0x48000000 0x7e0000 0x20000; bootaux 0x7e0000
			Hotkey: Ctrl+Alt+Q
...
tftp 0x48000000 imx8mp_m7_i2c_bpm_bq40z50.bin; cp.b 0x48000000 0x7e0000 0x20000; bootaux 0x7e0000
	or
# Press Ctrl+Alt+Q in minicom in Terminal

	Set autodownload M7 program by TFTP at startup in U-boot:
setenv boot_m7 'tftp 0x48000000 imx8mp_m7_i2c_bpm_bq40z50.bin; cp.b 0x48000000 0x7e0000 0x20000; bootaux 0x7e0000'
saveenv

	Set start program M7 from SD card
setenv boot_m7 'fatload mmc 1:1 0x48000000 imx8mp_m7_i2c_bpm_bq40z50.bin; cp.b 0x48000000 0x7e0000 0x20000; bootaux 0x7e0000'
saveenv
