...
#include "i2c_bpm_bq40z50_print.h"
	...
	/// read and write I2C
static bool i2c_bpm_bq40z50_read_register(uint8_t reg, uint8_t *received)
{
	uint8_t send[] = { reg };
	return i2c_task_read_data(send, sizeof(send), received, 1);
}

static bool i2c_bpm_bq40z50_read_2_registers(uint8_t reg, uint16_t *received)
{
	uint8_t send[] = { reg };
	uint8_t read[2];
...
static bool i2c_bpm_bq40z50_read_4_registers(uint8_t reg, uint32_t *received)
{
	uint8_t send[] = { reg };
	uint8_t read[4];
...
static bool i2c_bpm_bq40z50_write_register(uint8_t reg, uint8_t value)
{
	uint8_t data[] = { reg, value };
	return i2c_task_write_data(data, sizeof(data));
}

static bool i2c_bpm_bq40z50_write_4_registers(uint8_t reg, uint32_t value)
{
